...
- A list can be used directly as a [**target audience**](https://nuvia.mintlify.app/essentials/outbound/campaigns#2-define-your-target-audience) for outbound campaigns.
