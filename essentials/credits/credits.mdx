...
**Credits** are the transactional currency that powers various actions within the Nuvia platform—primarily the enrichment of company and people records. Credits are an essential part of every plan and are **recharged each billing cycle**. They can also be **purchased separately** as needed, either individually ([**pay-per-use**](/essentials/credits/payperuse)) or through [**credit bundles**](/essentials/credits/bundles).
