...
### Can I purchase multiple bundles in the same billing cycle?
...
### How does the system choose which bundle to consume first?
...
### Can bundle credits accumulate over time?
...
### What happens if I have leftover bundle credits that aren’t enough for the next action?
...
### What if I run out of credits and don’t have pay-per-use enabled?
...
### What happens to unused plan credits at the end of the cycle?
...
### Can a trial user purchase a bundle?
...
### If I cancel and reactivate my plan in the same cycle, can I buy a new bundle?
