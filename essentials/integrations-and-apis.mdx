...
Link your LinkedIn account to power [**Campaigns**](/essentials/outbound/campaigns). This integration allows you to import contacts and run outreach directly via LinkedIn messaging and connection requests from within Nuvia.
