...
**Records** is the data that functions as a **System of Action (SoA)** for sales representatives and commercial teams. Our CRM centralizes saved records of people and companies — sourced via Search or import — enabling organization, updates, and direct actions on each lead powered by AI.
